...
public class PanelBeans extends JPanel {

	private Image one = new ImageIcon(dashboard.class.getResource("/menuimg/Arabica.png")).getImage()
			.getScaledInstance(275, 215, Image.SCALE_SMOOTH);
	private Image two = new ImageIcon(dashboard.class.getResource("/menuimg/Excelsa.png")).getImage()
			.getScaledInstance(275, 215, Image.SCALE_SMOOTH);
	private Image three = new ImageIcon(dashboard.class.getResource("/menuimg/Liberica.png")).getImage()
			.getScaledInstance(275, 215, Image.SCALE_SMOOTH);
	private Image four = new ImageIcon(dashboard.class.getResource("/menuimg/Robusta.png")).getImage()
			.getScaledInstance(275, 215, Image.SCALE_SMOOTH);
	...
	public PanelBeans() {
		...
		JLabel name1 = new JLabel("ARABICA");
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (spinnerValue >= 1) {
					...
					JOptionPane.showMessageDialog(null,
							"<html><font color='#0e1d73'><b>ARABICA</b></font> has been added to your cart."
									+ "<br><br><b>ITEM:</b> " + spinnerValue + "</html>",
		...
		JLabel price1 = new JLabel("<html><strong>PRICE: </strong> ₱250.00");
		...
		JLabel name2 = new JLabel("EXCELSA");
		...
		addtocart2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (spinnerValue >= 1) {
					...
					ImageIcon icon = new ImageIcon(getClass().getResource("/img/check.png"));
					JOptionPane.showMessageDialog(null,
							"<html><font color='#0e1d73'><b>EXCELSA</b></font> has been added to your cart."
									+ "<br><br><b>ITEM:</b> " + spinnerValue + "</html>",
							"Successfully Added", JOptionPane.INFORMATION_MESSAGE, icon);
				} else {
					JOptionPane.showMessageDialog(null, "Please place an order before adding it to the cart.", "Warning",
		...
		JLabel price2 = new JLabel("<html><strong>PRICE: </strong> ₱499.00");
		...
		JLabel name3 = new JLabel("LIBERICA");
		...
		addtocart3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (spinnerValue >= 1) {
					...
					ImageIcon icon = new ImageIcon(getClass().getResource("/img/check.png"));
					JOptionPane.showMessageDialog(null,
							"<html><font color='#0e1d73'><b>LIBERICA</b></font> has been added to your cart."
									+ "<br><br><b>ITEM:</b> " + spinnerValue + "</html>",
							"Successfully Added", JOptionPane.INFORMATION_MESSAGE, icon);
				} else {
					JOptionPane.showMessageDialog(null, "Please place an order before adding it to the cart.", "Warning",
		...
		JLabel price3 = new JLabel("<html><strong>PRICE: </strong> ₱300.00");
		...
		JLabel name4 = new JLabel("ROBUSTA");
		...
		addtocart4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (spinnerValue >= 1) {
					...
					ImageIcon icon = new ImageIcon(getClass().getResource("/img/check.png"));
					JOptionPane.showMessageDialog(null,
							"<html><font color='#0e1d73'><b>ROBUSTA</b></font> has been added to your cart."
									+ "<br><br><b>ITEM:</b> " + spinnerValue + "</html>",
							"Successfully Added", JOptionPane.INFORMATION_MESSAGE, icon);
				} else {
					JOptionPane.showMessageDialog(null, "Please place an order before adding it to the cart.", "Warning",
		...
		JLabel price4 = new JLabel("<html><strong>PRICE: </strong> ₱299.00");
